...
/****** Object:  Database [LojaVirtual]    Script Date: 10/12/2018 19:32:43 ******/
CREATE DATABASE [LojaVirtual]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'LojaVirtual', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\LojaVirtual.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'LojaVirtual_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\LojaVirtual_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [LojaVirtual] SET COMPATIBILITY_LEVEL = 140
GO
